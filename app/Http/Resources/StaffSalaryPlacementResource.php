...
class StaffSalaryPlacementResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'allowance_total_snapshot' => $this->allowance_total_snapshot !== null ? (float) $this->allowance_total_snapshot : null,
            'allowance_breakdown_snapshot' => $this->allowance_breakdown_snapshot ?? [],
