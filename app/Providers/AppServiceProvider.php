...
use App\Policies\WorkplanIndicatorPolicy;
use App\Policies\WorkplanObjectivePolicy;
use App\Policies\WorkplanPolicy;
use App\Policies\WorkplanProgressReportPolicy;
use App\Policies\WorkplanEvidencePolicy;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Gate::policy(WorkplanObjective::class, WorkplanObjectivePolicy::class);
        Gate::policy(WorkplanActivity::class, WorkplanActivityPolicy::class);
        Gate::policy(WorkplanIndicator::class, WorkplanIndicatorPolicy::class);
        Gate::policy(WorkplanProgressReport::class, WorkplanProgressReportPolicy::class);
        Gate::policy(WorkplanEvidence::class, WorkplanEvidencePolicy::class);
