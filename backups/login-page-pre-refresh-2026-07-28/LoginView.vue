...
import mohLoginAnimation from '../../../images/niger-state-moh-mis-animated.gif';
...
const loginStatementStyle = computed(() => ({
    backgroundImage: `url(${appState.showMode === 'MOH' ? mohLoginAnimation : defaultLoginBackground})`,
}));
