...
<body>
    ...
    <table class="ref-table">
        <tr>
            ...
            <td class="reference">
                ...
                Date: <strong>{{ $generatedAt->format(\App\Support\ReportFormatter::DATE_FORMAT) }}</strong>
            </td>
        </tr>
    </table>
    ...
    <div class="footer">
        Generated by eHRMIS on {{ $generatedAt->format(\App\Support\ReportFormatter::DATETIME_FORMAT) }}. This letter is valid only after the approved posting workflow is complete.
    </div>
</body>
</html>
